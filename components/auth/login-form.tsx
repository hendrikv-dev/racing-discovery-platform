  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-4">
      ...
      <p className="text-sm text-zinc-300">
        New here?{" "}
        <Link href={`/signup?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="font-semibold text-violet-300 underline-offset-4 hover:text-violet-200 hover:underline">
          Create an account
        </Link>
      </p>
    </form>
